...
func Test_TsQueue_Empty(t *testing.T) {
	// Arrange

	// Act
	queue := generated.IntTsQueue{}
...
func Test_TsQueue_InitialValues(t *testing.T) {
	// Arrange
	val1, val2 := randGen.Int(), randGen.Int()
	// Act
	queue := generated.MakeIntTsQueue(val1, val2)
...
func Test_TsQueue_PushAndPop(t *testing.T) {
	// Arrange
	val1, val2 := randGen.Int(), randGen.Int()
...
func Test_TsQueue_Sort(t *testing.T) {
	// Arrange
	queue := generated.MakeIntTsQueue(3, 1, 2)
...
func Test_TsQueue_SortEmptyQueue(t *testing.T) {
	// Arrange
	queue := generated.IntTsQueue{}
